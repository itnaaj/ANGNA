...
$to = $_GET['email'];
$subject = "ANGNA PASSWORD RESET";

$message = '

<html>
<head>
<title>ANGNA PASSWORD RESET</title>
</head>
<body>
...
We recived a request to reset your ANGNA account password.</b>.
                                        </td>
                                    </tr>
                                    <tr style="font-family: Helvetica Neue,Helvetica,Arial,sans-serif; box-sizing: border-box; font-size: 14px; margin: 0;">
                                        <td class="content-block" style="font-family: Helvetica Neue,Helvetica,Arial,sans-serif; box-sizing: border-box; font-size: 12px; vertical-align: top; margin: 0; padding: 0 0 20px;" valign="top">

Enter the following OTP to reset your password:<br><br><br>
...
$headers .= 'From: ANGNA PASSWORD RESET <jnvgangna@gmail.com>' . "\r\n";
